      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            ...
            <p className="text-sm uppercase">Investors platform to fund startups</p>
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold">I am an Investor</h2>
          <p>Get access to thousands of verified startups to invest in & expand your investment portfolio.</p>
        ...
        <div className="space-y-4">
          ...
          <p>Get access to thousands of accredited investors & bring value added capital to your cap table.</p>
          <Button className="bg-[#2c3e50] hover:bg-[#1a252f] dark:bg-[#ffffff] dark:hover:bg-[#e0e0e0] text-white dark:text-[#2c3e50] w-full sm:w-auto">
            Join as Startup
          </Button>
        </div>
